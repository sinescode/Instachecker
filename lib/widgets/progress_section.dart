...
class ProgressSection extends StatelessWidget {
  ...
  final String originalFilename; // Added parameter for original filename
  ...
  const ProgressSection({
    ...
    required this.originalFilename, // Required parameter
  });
  ...
  Future<void> _downloadResults(BuildContext context) async {
    ...
    try {
      // Create filename with pattern: final_{originalFilename}
      final filename = 'final_$originalFilename';
